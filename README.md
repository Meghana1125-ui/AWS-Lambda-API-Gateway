...
![Lambda Function Created](screenshots/lamda-function-created.png)

## 3. Lambda Code Added

![Lambda Code Added](screenshots/lamda-code-added.png)

## 4. API Gateway Created

![API Gateway Created](screenshots/api-gateway-created.png)
...
![Missing Error](screenshots/missing-error.png)

## 10. Documentation Part Created

![Documentation Part Created](screenshots/documentation-part-created.png)

## 11. Documentation Published

![Documentation Published](screenshots/documentation-published.png)

## 12. API Exported

![API Exported](screenshots/api-exported.png)

## 13. OpenAPI ZIP Downloaded

![OpenAPI Downloaded](screenshots/openapi-zip-download.png)
